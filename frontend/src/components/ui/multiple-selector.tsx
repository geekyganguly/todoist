  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-lg border border-input text-sm ring-offset-background focus-within:ring-1 focus-within:ring-ring focus-within:ring-offset-2",
            {
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <button
              ...
              className={cn(
                "absolute right-0 p-0 text-muted-foreground",
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
        ...
        <div className="relative">
          {open && (
            ...
            >
              {isLoading ? (
                <CommandEmpty>{loadingIndicator}</CommandEmpty>
              ) : (
                <>
                  {EmptyItem()}
                  {CreatableItem()}
